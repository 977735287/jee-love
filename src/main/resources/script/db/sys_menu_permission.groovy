...
databaseChangeLog(logicalFilePath: 'sys_menu.groovy') {
    changeSet(author: 'Sanchar', id: '2018-12-26_sys_menu_permission') {
        createTable(tableName: 'sys_menu_permission', remarks: '菜单角色关联表') {
            column(name: 'id', type: 'bigint(20)', autoIncrement: 'true', remarks: '表ID，主键，供其他表做外键') {
                constraints(nullable: 'false', primaryKey: 'true', primaryKeyName: 'pk_sys_menu_permission')
            }
